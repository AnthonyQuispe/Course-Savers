    ...
    return (
        <div className="pt-[44px]">
            ...
            <section className="p-6 pt-2 flex flex-col justify-between h-full">
                <h1 className=" text-xl text-PrimaryPurp font-extrabold">CONFIRMATION</h1>
                <div className="py-[15rem] px-6">
                    <h2 className=" text-PrimaryPurp text-lg font-extrabold pb-4">You're Done!</h2>
                    <p className=" text-lg">You've successfully finalized your classes for the term.</p>
                </div>
